...
IL_003d:
	...
	}
	{
		...
		NetworkAuthenticator_ServerAccept_m6D58A59FA3DC77945119F9BAE8532745BD3B6C7E(__this, L_16, NULL);
		goto IL_00cb;
	}
...
IL_0075:
	{
		...
		NetworkConnection_t49880296B0FA972023F34582D7A41D7B63383E78* L_18 = ___conn0;
		NullCheck(L_17);
		bool L_19;
		...
		NetworkConnection_t49880296B0FA972023F34582D7A41D7B63383E78* L_23 = ___conn0;
		NullCheck(L_23);
		L_23->___isAuthenticated_3 = (bool)0;
		// StartCoroutine(DelayedDisconnect(conn, 1f));
		NetworkConnection_t49880296B0FA972023F34582D7A41D7B63383E78* L_24 = ___conn0;
		RuntimeObject* L_25;
		L_25 = BasicAuthenticator_DelayedDisconnect_m8EC67FF0DB6E995753F7901CB7B93DEEE466B801(__this, L_24, (1.0f), NULL);
...
IL_0045:
	{
		...
		NetworkConnection_t49880296B0FA972023F34582D7A41D7B63383E78* L_5 = __this->___conn_2;
		NullCheck(L_4);
		NetworkAuthenticator_ServerReject_m97FC646AC4B9554D005DE002C4289C20EC75A250(L_4, L_5, NULL);
		// yield return null;
...
IL_006e:
	{
		...
		NetworkConnection_t49880296B0FA972023F34582D7A41D7B63383E78* L_8 = __this->___conn_2;
		NullCheck(L_7);
		bool L_9;
...
IL_0042:
	{
		...
		NullCheck(L_8);
		NetworkConnection_Send_TisAuthRequestMessage_t8AAEEE283D9AFEC2765C90E610FE9ED73FEF3CC9_m96BD6C0022DF5F1576D4A079E594DDB641104E41(L_8, L_10, 0, NetworkConnection_Send_TisAuthRequestMessage_t8AAEEE283D9AFEC2765C90E610FE9ED73FEF3CC9_m96BD6C0022DF5F1576D4A079E594DDB641104E41_RuntimeMethod_var);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void TimeoutAuthenticator_OnServerAuthenticate_m6DC80331CD2975A12F3BC870865A0FA76985EC9E (TimeoutAuthenticator_t49D2A5C5AB3EF3E0D31F9626A779B82B9C916315* __this, NetworkConnection_t49880296B0FA972023F34582D7A41D7B63383E78* ___conn0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NetworkConnection_t49880296B0FA972023F34582D7A41D7B63383E78* L_4 = ___conn0;
		RuntimeObject* L_5;
...
IL_003f:
	{
		...
		NullCheck(L_6);
		bool L_7 = L_6->___isAuthenticated_3;
